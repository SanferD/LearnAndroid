    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mReportButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                String subject = getString(R.string.crime_report_suspect);
        ...
        mCallSuspectButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                String telnum = String.format("tel:%s", mCrime.getPhone());
                Uri uri_number = Uri.parse(telnum);
                Intent i = new Intent(Intent.ACTION_DIAL, uri_number);
                startActivity(i);
            }
        });
